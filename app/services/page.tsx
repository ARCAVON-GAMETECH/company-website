  ...
  const services = [
    {
      ...
      description:
        "Bringing your vision to life with stunning 2D artwork and design.",
    },
    {
    ...
    },
    {
      ...
      description:
        "Ensuring flawless gameplay through rigorous testing protocols.",
    },
  ];
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {services.map((service, index) => (
            ...
            >
              ...
              <h3 className="text-xl text-white font-bold mb-3 uppercase tracking-wide font-[family-name:var(--font-hanuman)]">
                {service.title}
              </h3>
              ...
              <div className="space-y-3 mb-6">
                {service.features.map((feature, idx) => (
                  <div key={idx} className="flex items-center gap-2">
                    ...
                    <span className="text-gray-400 text-sm uppercase tracking-wider font-[family-name:var(--font-inter)]">
                      {feature}
                    </span>
                  </div>
                ))}
              ...
              <div className="space-y-5">
                  ...
                  <div className="relative">
                    ...
                    {dropdownOpen && (
                      <div className="absolute top-full left-0 right-0 mt-2 bg-black/95 backdrop-blur-xl border border-[#00c2ff]/30 rounded-lg overflow-hidden z-10">
                        {["2D Art", "3D Art & Animation", "Game Testing"].map(
                          (service) => (
                            <button
                              key={service}
                              type="button"
                              ...
                              className={`w-full px-5 py-3 text-left transition-all font-[family-name:var(--font-inter)] ${
                ...
                <div className="flex flex-col gap-4 pt-2">
                  <button
                    ...
                    className={`w-full px-6 py-4 rounded-lg font-semibold tracking-wide transition-all flex items-center justify-center gap-2 font-[family-name:var(--font-bunken)] ${
                      submitted
                  ...
                  {error && (
                    <div className="p-4 bg-red-500/10 border border-red-500/50 rounded-lg">
                      <p className="text-red-400 text-sm text-center font-[family-name:var(--font-inter)]">
                        {error}
                      </p>
                    </div>
                  )}
